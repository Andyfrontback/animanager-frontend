...
- **Bento Grid:** Exposición de funcionalidades principales mediante _Tilt Cards_ con efectos de perspectiva 3D y animaciones de entrada fluidas (Motion).

![Home Hero Section](public/image.png)
...
- **UI Adaptativa:** Los filtros se presentan en un `Modal` para escritorio y un `Drawer` para dispositivos móviles.
  ![Browse Anime Module](public/image-1.png)
...
- **Data Table Pro:** Tabla responsive completa con capacidades de ordenamiento, filtrado por múltiples atributos y acciones de borrado.
  ![User Dashboard Module](public/image-2.png)

### 🏆 Tierlist Interactiva

- **Drag & Drop:** Sistema de ranking (S, A, B, C, D) implementado con **@dnd-kit**.
- **Sincronización:** Los animes de tu _Watched List_ están disponibles inmediatamente para ser rankeados.
  ![Anime Tierlist Maker Module](public/image-3.png)

### 📱 Layout & UX

- **Sidebar & Header:** Navegación fluida con Breadcrumbs funcionales.
- **Watched List Sheet:** Acceso rápido lateral a la lista de seguimiento con una tabla optimizada: \* _Mobile:_ Vista simplificada con Tabs para cambiar entre campos. \* _Desktop:_ Vista tabular completa.
  ![Sidebar and Sheet](public/image-4.png)
...
- **Optimización de Renderizado:** Se eliminó el uso de Web Workers para el borrado de la lista para evitar _flickering_ en la UI, optando por una actualización síncrona del estado en Zustand para una respuesta inmediata.
...
- **Responsive Design:** Implementación de tablas dinámicas que cambian su representación de datos según el _viewport_ del dispositivo.
